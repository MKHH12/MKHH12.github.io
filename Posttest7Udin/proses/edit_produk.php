<?php
    ...
    if(isset($_GET['id'])) {
        ...
        if(!count($data)) {
            echo "<script>alert('Data tidak ditemukan pada Table');window.location='../halaman1/test.php';</script>";

        }


    } else {
        echo "<script>alert('Masukkan ID yang ingin di EDIT');window.location='../halaman1/test.php';</script>";
    }
